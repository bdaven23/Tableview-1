...
-(UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (tableView ==self.tableView){
        ...
        ((UILabel*)[cell viewWithTag:101]).font = [UIFont preferredFontForTextStyle:UIFontTextStyleHeadline];
        ((UILabel*)[cell viewWithTag:102]).font = [UIFont preferredFontForTextStyle:UIFontTextStyleSubheadline];
        ((UILabel*)[cell viewWithTag:103]).font = [UIFont preferredFontForTextStyle:UIFontTextStyleFootnote];
    } else {
